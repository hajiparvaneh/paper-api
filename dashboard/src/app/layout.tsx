...
export const metadata: Metadata = {
  ...
  description:
    "Self-hosted control plane for PaperAPI: manage keys, watch usage, and monitor PDF jobs locally.",
  icons: {
    icon: "/favicon.svg",
  },
};
          ...
          <div className="relative z-10 flex min-h-screen flex-col">
            ...
            <footer className="border-t border-white/10 bg-slate-950/70">
              <div className="mx-auto flex max-w-6xl flex-wrap items-center justify-between gap-4 px-6 py-6 text-xs text-slate-400">
                <span className="uppercase tracking-[0.3em] text-slate-300">PaperAPI self-hosted</span>
